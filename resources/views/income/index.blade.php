  ...
  <div class="main-content">
    <section class="section">
      ...
      <div class="section-body">
        <h2 class="section-title">Income Page</h2>
        <p class="section-lead">This page is showing income data.</p>
        <div class="card">
  ...
  <script type="text/javascript">
    ...
    function remove(e, id) {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            axios.post('/income/' + id, {
              _method: 'delete',
              _token: $('#csrftoken').val()
            }).then(function(response) {
              if (response.data) {
                swal('Good Job', 'Income success deleted', 'success');
                table.ajax.reload();
              }
